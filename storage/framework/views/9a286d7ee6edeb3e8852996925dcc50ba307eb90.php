    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                ...
                <h2 class="section-heading">O que é o <img class="img-responsive" src="img/pes2.png" width="90px" height="40px"> ? </h2>
                <p class="lead">O projeto consiste em melhorar o processo de aplicação de atividades online dentro de uma escola, visando a melhora na interação entre alunos e professores no processo de aprendizado estimulando o raciocínio lógico do aluno e consequentemente, melhorando suas notas.</p>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <a href="/register" type="button" class="btn btn-primary btn-lg btn-block">CADASTRAR</button></a>
                    <hr>
